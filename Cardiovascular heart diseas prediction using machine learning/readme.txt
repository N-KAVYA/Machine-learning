...
> GUI based prediction of heart disease (Module-06)
...
5. Select an install for “Just Me” unless you’re installing for all users (which require Windows Administrator privileges) and click Next.
...
3. Congratulations, you have installed Jupyter Notebook. To run the notebook type the following command in the command prompt
jupyter notebook
